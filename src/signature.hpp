...
namespace rivet_hook {
	...
	MAKE_SIGNATURE(IS_VALID_ASSET, "40 53 48 83 EC 20 8B D9 0F B6 CA")
	...
	MAKE_SIGNATURE(IS_ASSET_HEADER_VALID_RCRA, "48 89 5C 24 ?? 48 89 6C 24 ?? 48 89 74 24 ?? 57 48 83 EC 20 48 8B DA 48 8B F9 E8 ?? ?? ?? ?? 8B F0")
